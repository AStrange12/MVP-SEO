  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to LocalBoost AI.",
      });
    ...
    <div className="min-h-[calc(100vh-80px)] hero-gradient flex items-center justify-center p-6">
      <Card className="w-full max-w-md glass-morphism border-white/10 overflow-hidden">
        <CardHeader className="text-center pb-8 pt-10">
          ...
          <CardTitle className="text-3xl font-headline font-bold">Start Your Journey</CardTitle>
          <CardDescription className="text-lg">Create an account to build your presence.</CardDescription>
        </CardHeader>
        <CardContent>
